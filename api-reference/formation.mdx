...
| ------ | --------------------------------------------------------------------- | -------------------------------------------------- |
| POST   | [/formations](/api-reference/endpoint/initiate-formation)             | Start the company formation process                |
| GET    | [/formations/:company_id](/api-reference/endpoint/retrieve-formation) | Retrieve the current status of a company formation |
